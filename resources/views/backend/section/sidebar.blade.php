        ...
        <li class="{{ setSidebar(['admin.slider*', 'admin.info*', 'admin.partner*', 'admin.subscriber*', 'admin.site-setting*', 'admin.page-setting*']) }}">
            ...
            <ul>
                ...
                <li class="{{ setSidebar(['admin.subscriber*']) }}">
                    <a href="{{route('admin.subscriber.index')}}"><i class='bx bx-radio-circle'></i>Manage Subscriber</a>
                </li>
                ...
                <li class="{{ setSidebar(['admin.page-setting*']) }}">
                    <a href="{{route('admin.page-setting.index')}}"><i class='bx bx-radio-circle'></i>Page Settings</a>
                </li>
        ...
        <li class="{{ setSidebar(['admin.blog*', 'admin.blog-category*']) }}">
            ...
            <ul>
                <li class="{{ setSidebar(['admin.blog-category*']) }}">
                    <a href="{{route('admin.blog-category.index')}}"><i class='bx bx-radio-circle'></i>All Blog Category</a>
                </li>
