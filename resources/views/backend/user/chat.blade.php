...
<body>
    <div class="d-flex">
        {{-- global (left) navigation sidebar that’s in every page --}}
        @include('backend-components.users.sidebar')

        <div class="flex-grow-1 d-flex flex-column">
            {{-- top bar / hamburger / account menu --}}
            ...
            <div class="chat-wrapper p-lg-5 p-md-3">
                ...
                <div class="chat-sidebar">
                    ...
                    <div class="contact-list">
                        ...
                        <div class="contact-row d-flex">
                            <img src="https://i.pravatar.cc/48?img=5" width="48" height="48"
                        ...
                        <div class="contact-row active d-flex">
                            <img src="https://i.pravatar.cc/48?img=15" width="48" height="48"
                                class="rounded-circle" alt="">
                            <div class="flex-grow-1 overflow-hidden">
                ...
                <div class="chat-pane">
                    ...
                    <div class="contact-header">
                        <img src="https://i.pravatar.cc/44?img=15" width="44" height="44"
