            ...
            <div class="card card-item dashboard-info-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="pl-4">
                        ...
                        <h5 class="card-title pt-2 fs-26">{{ $enrolled_course }}</h5>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div><!-- end col-lg-4 -->
            ...
            <div class="card card-item dashboard-info-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="pl-4">
                        ...
                        <h5 class="card-title pt-2 fs-26">{{ $wishlist_course }}</h5>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div><!-- end col-lg-4 -->
            ...
            <div class="card card-item dashboard-info-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="pl-4">
                        ...
                        <h5 class="card-title pt-2 fs-26">${{ $total_purchase_amount }}</h5>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div><!-- end col-lg-4 -->
