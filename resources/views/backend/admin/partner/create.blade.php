        ...
        <div class="card col-md-8">
            ...
            <div class="card-body">
                ...
                <div class="card-body p-4">
                    ...
                    <form class="row g-3" method="post" action="{{route('admin.partner.store')}}" enctype="multipart/form-data">
                        @csrf
...
@endif
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="name" id="partner_name" placeholder="Enter the partner name">
                        </div>
