            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="post" action="{{route('admin.info.update', $first_info->id)}}" enctype="multipart/form-data">
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="post" action="{{route('admin.info.update', $second_info->id)}}" enctype="multipart/form-data">
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="post" action="{{route('admin.info.update', $third_info->id)}}" enctype="multipart/form-data">
