         ...
         <nav class="navbar navbar-expand gap-3">
             ...
             <div class="top-menu ms-auto">
                 <ul class="navbar-nav align-items-center gap-1">
                     <li class="nav-item mobile-search-icon d-flex d-lg-none w-sm-100" data-bs-toggle="modal"
                         data-bs-target="#SearchModal">
                         <input class="form-control px-lg-5 px-1" type="search" placeholder="Search">
                     </li>
