            ...
            <div class="col-lg-10 mx-auto">
                <div class="card card-item">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" class="row" action="{{ route('instructor.register.store') }}">
                            @csrf
                            <div class="input-box col-lg-6">
                                <label class="label-text">First Name</label>
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="first_name"
                                        placeholder="e.g. Alex" value="{{ old('first_name') }}">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="name"
                                        placeholder="e.g. Smith" value="{{ old('name') }}">
                                    <span class="la la-user input-icon"></span>
                                </div>
                            </div><!-- end input-box -->
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="email" name="email"
                                        placeholder="e.g. alexsmith@gmail.com" value="{{ old('email') }}">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input id="phone" class="form-control form--control" type="text"
                                        name="phone">
                                </div>
                            </div><!-- end input-box -->
                            <div class="input-box col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 form-group">
                                        <div class="select-container w-auto">
                                            <select class="select-container-select" name="day">
                                    ...
                                    <div class="col-lg-4 form-group">
                                        <div class="select-container w-auto">
                                            <select class="select-container-select" name="month">
                                    ...
                                    <div class="col-lg-4 form-group">
                                        <div class="select-container w-auto">
                                            <select class="select-container-select" name="year">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" placeholder="City"
                                        name="city">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <div class="select-container w-auto">
                                        <select class="select-container-select" name="country">
