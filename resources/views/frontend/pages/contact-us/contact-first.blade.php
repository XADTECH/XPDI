    ...
    <div class="col-lg-4 responsive-column-half">
        <div class="info-box">
            ...
            <div class="icon-element mx-auto shadow-sm">
                <svg class="svg-icon-color-1" width="45" viewBox="0 0 512 512"
            ...
            <p class="info__text">{{getSiteInfo()->address}}</p>
        </div><!-- end info-box -->
    </div><!-- end col-lg-3 -->
    <div class="col-lg-4 responsive-column-half">
        <div class="info-box">
        ...
        <div class="info-box">
            ...
            <div class="icon-element mx-auto shadow-sm">
                <svg class="svg-icon-color-3" width="40" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 473.806 473.806"
                    xml:space="preserve">
                    <g>
                        <g>
            ...
            <p class="info__text">{{getSiteInfo()->phone}}</p>
