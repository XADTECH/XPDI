                ...
                <div class="card-image">
                    <a href="course-details.html" class="d-block">
                        <img class="card-img-top lazy" width="200" height="200"
                            src="{{ asset($course['course_image']) }}" data-src="{{ asset($course['course_image']) }}"
                            alt="Card image cap">
                    </a>
                    ...
                    <div class="rating-wrap d-flex align-items-center py-2">
                        <div class="review-stars">
                            ...
                            @php
                                ...
                                $averageRating = \App\Models\Review::where('course_id', $course['id'])
                                    ->where('status', 1)
                                    ->avg('rating');
...
@include('frontend.pages.all-courses.paginate')
