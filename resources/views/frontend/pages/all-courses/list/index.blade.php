...
@section('content')
    ...
    @include('frontend.section.breadcrumb', ['title' => 'All Courses List View'])
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-item card-preview card-item-list-layout tooltipstered" data-tooltip-content="#{{$course->course_name_slug}}">
